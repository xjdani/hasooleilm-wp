...
<main id="primary" class="py-10 md:py-16" role="main">
    <div class="max-w-[900px] mx-auto px-5 lg:px-10">
        
        <?php if ( have_posts() ) : ?>
            
            <div class="grid gap-6 md:gap-8 mb-12">
                
                <?php while ( have_posts() ) : the_post(); ?>
                    
                    <!-- post_class() is kept for WordPress plugin compatibility -->
                    <article id="post-<?php the_ID(); ?>" <?php post_class( 'bg-white border border-gray-200 rounded-xl p-5 md:p-8 transition-shadow hover:shadow-lg' ); ?>>
                        ...
                        <div class="mb-4">
                            ...
                            <?php if ( is_singular() ) : ?>
                                <!-- 'prose' is from @tailwindcss/typography plugin if you use it, otherwise standard styles apply -->
            ...
            <nav class="my-12" role="navigation" aria-label="<?php esc_attr_e( 'Posts navigation', 'hasooleilm-lms' ); ?>">
                ...
                the_posts_pagination( array(
                    'mid_size'  => 2,
                    'prev_text' => __( '← Previous', 'hasooleilm-lms' ),
                    'next_text' => __( 'Next →', 'hasooleilm-lms' ),
